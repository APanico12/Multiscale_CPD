...
dgp_functions <- list(
  ...
  "Clayton_Sine" = function(n_val, d_val) {
    Gen.from.clayton(n = n_val, d = d_val, theta = theta.Clayton,
...
write.csv(sim_results, "simulation_results_clayton.csv", row.names = FALSE)
cat("Simulation complete. Results saved to simulation_results_clayton.csv.\n")