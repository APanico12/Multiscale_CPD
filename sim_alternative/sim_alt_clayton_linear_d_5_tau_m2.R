...
write.csv(sim_results, "sim_alt_clayton_linear_d_5_tau_m2.csv", row.names = FALSE)
cat("Simulation complete. Results saved to sim_alt_clayton_linear_d_5_tau_m2.csv.\n")
