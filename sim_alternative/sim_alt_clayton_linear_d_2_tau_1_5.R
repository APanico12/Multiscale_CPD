...
#Implement the DGP
dgp_functions <- list(
  "Clayton_Linear_Alternative" = function(n_val, d_val) {
    Gen.from.clayton.alt(n = n_val, d = d_val, marginal_df = nu_param)
  }
)
...
write.csv(sim_results, "sim_alt_clayton_linear_d_2_tau_1_5.csv", row.names = FALSE)
cat("Simulation complete. Results saved to sim_alt_clayton_linear_d_2_tau_1_5.csv.
")
