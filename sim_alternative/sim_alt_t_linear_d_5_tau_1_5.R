...
#Implement the DGP
dgp_functions <- list(
  "t_Linear_Alternative" = function(n_val, d_val) {
    Gen.from.t.alt(n = n_val, d = d_val, scenario = "linear", marginal_df = nu_param)
  }
)
...
write.csv(sim_results, "sim_alt_t_linear_d_5_tau_1_5.csv", row.names = FALSE)
cat("Simulation complete. Results saved to sim_alt_t_linear_d_5_tau_1_5.csv.")
