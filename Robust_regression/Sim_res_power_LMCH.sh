#!/bin/bash
#SBATCH --job-name=sim_tv_reg_power_LMCH
#SBATCH --account=T_STAGE_LUIGI_GROSSI
#SBATCH --mail-user=antonio.panico@unipr.it
#SBATCH --mail-type=END,FAIL 
#SBATCH --output=mc_output_power_LMCH_%j.txt
#SBATCH --error=mc_error_power_LMCH_%j.txt
...
# Model: Model I (LMCH: Conditional Heteroscedasticity)
