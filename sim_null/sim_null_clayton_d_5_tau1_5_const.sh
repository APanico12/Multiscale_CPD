#!/bin/bash
#SBATCH --job-name=sim_null_clayton_d_5_tau1_5_const
...
echo "Starting simulation for sim_null_clayton_d_5_tau1_5_const..."
Rscript sim_null_clayton_d_5_tau1_5_const.R
