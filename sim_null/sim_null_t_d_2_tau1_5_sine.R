...
dgp_functions <- list(
  ...
  "T_Copula_Sine" = function(n_val, d_val) {
...
write.csv(sim_results, "sim_null_t_d_2_tau1_5_sine.csv", row.names = FALSE)
cat("Simulation complete. Results saved to sim_null_t_d_2_tau1_5_sine.csv\n")