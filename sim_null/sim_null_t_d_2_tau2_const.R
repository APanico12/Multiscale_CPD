...
write.csv(sim_results, "sim_null_t_d_2_tau2_const.csv", row.names = FALSE)
cat("Simulation complete. Results saved to sim_null_t_d_2_tau2_const.csv.\n")