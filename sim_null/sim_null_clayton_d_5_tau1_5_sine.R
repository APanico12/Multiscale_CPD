...
write.csv(sim_results, "sim_null_clayton_d_5_tau1_5_sine.csv", row.names = FALSE)
cat("Simulation complete. Results saved to sim_null_clayton_d_5_tau1_5_sine.csv.
")