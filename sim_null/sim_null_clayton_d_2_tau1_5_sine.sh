#!/bin/bash
#SBATCH --job-name=sim_null_clayton_d_2_tau1_5_sine
...
echo "Starting simulation for sim_null_clayton_d_2_tau1_5_sine..."
Rscript sim_null_clayton_d_2_tau1_5_sine.R
