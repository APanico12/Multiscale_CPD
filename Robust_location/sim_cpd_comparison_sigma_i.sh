#!/bin/bash
#SBATCH --job-name=cpd_sigma_i
#SBATCH --account=T_STAGE_LUIGI_GROSSI
#SBATCH --mail-user=antonio.panico@unipr.it
#SBATCH --mail-type=END,FAIL 
#SBATCH --output=mc_output_cpd_sigma_i_%j.txt
#SBATCH --error=mc_error_cpd_sigma_i_%j.txt
...
OUTPUT_RAW="sim_results_cpd_comparison_sigma_i.csv"
OUTPUT_SUMMARY="sim_summary_cpd_comparison_sigma_i.csv"
...
# Execute parallel Monte Carlo simulation for CPD Comparison (Variance Scenario i)
